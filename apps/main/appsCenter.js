import { defineComponent as D, ref as I, onMounted as U, resolveComponent as V, openBlock as s, createElementBlock as l, withModifiers as b, unref as a, createVNode as x, Transition as N, withCtx as y, withDirectives as g, createElementVNode as e, toDisplayString as f, Fragment as k, renderList as w, normalizeStyle as C, normalizeClass as z, vShow as S, createTextVNode as T, pushScopeId as $, popScopeId as B } from "/libs/vue.js";
import L, { urls as M, Langs as O } from "/libs/view.js";
import { open as P } from "/libs/navigator.js";
import R from "/libs/network.js";
import W from "/libs/pointer.js";
import { menu as m, appsState as _, controllerSwitch as E, historys as F } from "/libs/state.js";
const j = (o) => ($("data-v-0decf28b"), o = o(), B(), o), X = { class: "all-menu" }, Y = /* @__PURE__ */ j(() => /* @__PURE__ */ e("h3", { class: "center" }, null, -1)), q = { class: "apps-center scroll-y" }, G = { class: "historys" }, H = { class: "title" }, J = ["href", "onClick"], K = { class: "name" }, Q = { class: "all-apps" }, Z = { class: "title" }, ee = /* @__PURE__ */ j(() => /* @__PURE__ */ e("i", { class: "icon ficon-fenlei" }, null, -1)), te = { class: "all-items" }, ne = ["href", "onClick"], ae = { class: "name" }, oe = /* @__PURE__ */ D({
  __name: "appsCenter",
  setup(o) {
    m.lock === void 0 && (m.lock = !0, R.get("/api/menu.json").then((t) => {
      for (const p of t) {
        const d = M[p];
        d && m.push(d);
      }
