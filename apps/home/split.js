import I from "/demo/libs/network.js";
import { Langs as C, setThemeColor as N, urls as V, mode as j } from "/demo/libs/view.js";
import { openBlank as D, open as E } from "/demo/libs/navigator.js";
import { menu as c, historys as B } from "/demo/libs/state.js";
import { back as T } from "/demo/libs/router.js";
import { openBlock as s, createElementBlock as o, Fragment as x, createElementVNode as a, createStaticVNode as F, resolveComponent as L, createTextVNode as A, toDisplayString as m, renderList as _, withModifiers as g, normalizeStyle as k, normalizeClass as y, withDirectives as G, createVNode as b, withCtx as w, TransitionGroup as M, vShow as O, createCommentVNode as q, pushScopeId as H, popScopeId as J } from "/demo/libs/vue.js";
...
function X(d, e, v, i, r, n) {
  return s(), o(x, null, [
    a("div", R, [
      ...
      a("div", {
        class: "close center",
        onClick: e[0] || (e[0] = (...p) => n.close && n.close(...p))
      }, "\u53D6\u6D88")
    ]),
    W
  ], 64);
...
c.lock === void 0 && (c.lock = !0, I.get("/demo/api/menu.json").then((d) => {
  for (const e of d) {
    const v = V[e];
    v && c.push(v);
  }
...
`, $ = (d) => (H("data-v-162cdfaf"), d = d(), J(), d), ea = { class: "apps-center" }, ia = { class: "search center" }, ta = /* @__PURE__ */ $(() => /* @__PURE__ */ a("i", { class: "ficon-sousuo-sousuo" }, null, -1)), va = { class: "apps-items" }, sa = ["href", "onClick"], oa = { class: "name" }, na = /* @__PURE__ */ $(() => /* @__PURE__ */ a("div", { class: "padding" }, null, -1)), ra = {
  key: 0,
  class: "historys"
}, ca = ["href", "onClick"], pa = { class: "link" }, la = { class: "name" };
function fa(d, e, v, i, r, n) {
  const p = L("Scroll");
  return s(), o("div", ea, [
    a("div", ia, [
      a("div", {
    ...
    a("div", va, [
      (s(!0), o(x, null, _(i.menu, ({ url: t, name: l, icon: f, color: h, target: u }) => (s(), o("div", {
        class: "item",
        key: t
      }, [
        a("a", {
          class: "link",
          href: t,
          onClick: g((S) => n.open(t, u), ["prevent"])
        }, [
          a("div", {
            class: "icon center",
            style: k({ color: h })
    ...
    na,
    i.mode === "split" ? G((s(), o("div", ra, [
      b(p, { class: "apps" }, {
        default: w(() => [
          b(M, { name: "scale" }, {
            default: w(() => [
              (s(!0), o(x, null, _(i.historys, ({ url: t, name: l, icon: f, color: h, target: u }) => (s(), o("a", {
                key: t,
                href: t,
                class: "item",
                onClick: g((S) => n.open(t, u), ["prevent"])
