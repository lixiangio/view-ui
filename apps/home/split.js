...
const ad = /* @__PURE__ */ S(W, [["render", dd], ["styles", [R]], ["__scopeId", "data-v-d39c5933"]]), j = (i) => (G("data-v-4053498c"), i = i(), M(), i), id = { class: "apps-center" }, td = { class: "search center" }, vd = /* @__PURE__ */ j(() => /* @__PURE__ */ d("i", { class: "ficon-sousuo-sousuo" }, null, -1)), ed = { class: "apps-items" }, cd = ["href", "onClick"], sd = { class: "name" }, od = /* @__PURE__ */ j(() => /* @__PURE__ */ d("div", { class: "padding" }, null, -1)), nd = {
  key: 0,
  class: "historys"
...
}), fd = `.split .apps-center[data-v-4053498c]{max-width:1100px;margin:0 auto}.apps-center .search[data-v-4053498c]{padding:12px}.apps-center .search .search-button[data-v-4053498c]{background-color:#fff3;border-radius:10px;border:unset;width:100%;height:38px;cursor:pointer;color:#e9e9e9}.apps-center .search .search-button i[data-v-4053498c]{font-size:15px;margin-right:8px}.apps-center .link[data-v-4053498c]{display:flex;flex-direction:column;align-items:center;cursor:pointer;padding:8px 10px;color:#fff}.apps-center .link .icon[data-v-4053498c]{width:66px;height:66px;background-color:#e5e5e529;border-radius:22px;margin-bottom:6px}.apps-center .link .icon i[data-v-4053498c]{font-size:30px}.apps-center .link .name[data-v-4053498c]{font-size:12px;font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.apps-center .apps-items[data-v-4053498c]{display:flex;flex-direction:row;flex-wrap:wrap;justify-content:flex-start}.apps-center .apps-items .item[data-v-4053498c]{display:flex;justify-content:center;align-items:center;overflow:hidden;margin-bottom:8px;width:10%}.apps-center .historys[data-v-4053498c]{position:fixed;bottom:4px;left:4px;right:4px;border-radius:8px;backdrop-filter:blur(20px)}.apps-center .historys .apps[data-v-4053498c]{text-align:center}.apps-center .historys .apps .item[data-v-4053498c]{display:inline-block;margin-bottom:0;transition:all .4s}.apps-center .historys .apps .item .link[data-v-4053498c]{padding:12px 10px}.apps-center .padding[data-v-4053498c]{height:150px}container[level="100"] .apps-items .item[data-v-4053498c]{width:25%!important}container[level="150"] .apps-items .item[data-v-4053498c]{width:16.6%!important}container[level="200"] .apps-items .item[data-v-4053498c]{width:12.5%!important}
`, bd = /* @__PURE__ */ S(ud, [["styles", [fd]], ["__scopeId", "data-v-4053498c"]]);
export {
  bd as default
};
